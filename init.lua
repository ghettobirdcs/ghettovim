...
require('lazy').setup({
  ...
  { -- Useful plugin to show you pending keybinds.
    ...
    config = function() -- This is the function that runs, AFTER loading
      ...
      require('which-key').add {
        ...
        -- MY CUSTOM KEYBINDS (ghettobird)
        { '<leader>H', group = '[H]arpoon' },
        { '<leader>L', group = '[L]ive Server' },
        { '<leader>x', group = 'Emmet' },
        { '<leader>Ls', vim.cmd.LiveServerStart, desc = '[L]ive Server [S]tart', mode = 'n' },
  ...
  { -- Highlight, edit, and navigate code
    ...
    build = ':TSUpdate',
    opts = {
      ensure_installed = { 'bash', 'c', 'diff', 'html', 'css', 'lua', 'luadoc', 'markdown', 'markdown_inline', 'query', 'vim', 'vimdoc', 'java', 'python' },
